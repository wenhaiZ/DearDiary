...
class DiaryDbHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_SQL = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME
            + " (" + COLUMN_ID + TEXT_TYPE + " PRIMARY kEY," + COLUMN_YEAR + INT_TYPE + "," + COLUMN_MONTH + INT_TYPE
            + "," + COLUMN_DAY_OF_MONTH + INT_TYPE + "," + COLUMN_DAY_OF_WEEK + INT_TYPE + "," + COLUMN_HOUR + INT_TYPE + ","
            + COLUMN_MINUTE + INT_TYPE + "," + COLUMN_TITLE + TEXT_TYPE + "," + COLUMN_CONTENT + TEXT_TYPE + ")";
